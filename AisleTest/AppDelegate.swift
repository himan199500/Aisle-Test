...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "AisleTest")
...
//MARK: - Navigation As per Login Status
extension AppDelegate{
    ...
    func navigate(to destination: Destination) {
        ...
        switch destination {
        case .home:
            controller = NotesViewController.instantiateFrom(storyboard: .aisle)
        ...
        case .preLogin:
            controller = LoginViewController.instantiateFrom(storyboard: .main)
            let navController = UINavigationController(rootViewController: controller)
            navController.isNavigationBarHidden = isNavBarHidden
            navController.navigationBar.backgroundColor = .white
            window?.rootViewController = navController
